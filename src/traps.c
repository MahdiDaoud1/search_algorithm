 ...
 *   CELL_BONUS_BOMB   0   explosion  no score effect, opens adjacent walls
...
static const CellType TYPES[] = {
    CELL_TRAP_SPIKE,  CELL_TRAP_SPIKE,  CELL_TRAP_SPIKE,  CELL_TRAP_SPIKE,                  // 4 spikes
    CELL_TRAP_FREEZE, CELL_TRAP_FREEZE, CELL_TRAP_FREEZE,                                   // 3 freeze
    CELL_TRAP_TELE,   CELL_TRAP_TELE,   CELL_TRAP_TELE,                                     // 3 vortex
    CELL_BONUS_BOMB,  CELL_BONUS_BOMB,  CELL_BONUS_BOMB,                                    // 3 bomb
    CELL_BONUS_SPEED, CELL_BONUS_SPEED, CELL_BONUS_SPEED, CELL_BONUS_SPEED,                 // 4 speed_up
    CELL_BONUS_COIN,  CELL_BONUS_COIN,  CELL_BONUS_COIN, CELL_BONUS_COIN,  CELL_BONUS_COIN, // 5 coins
};
#define N_TYPES (int)(sizeof(TYPES)/sizeof(TYPES[0])) //22
...
void traps_place(Grid *g) {
    ...
    // random positioning (Fisher-Yates shuffle)
